        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <span class="nav-link">Scrap Control Monitoring</span>
                </li>
            </ul>
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    ...
                    <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('admnscrap/update_delete_smt'); ?>" class="nav-link">
                                <i class="far fa-edit nav-icon"></i>
                                <p>Update Data Part</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= base_url('admnscrap/part_number_baru'); ?>" class="nav-link">
                                <i class="fas fa-pen-alt nav-icon"></i>
                                <p>Add Data Baru</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= base_url('admnscrap/part_mesin_baru'); ?>" class="nav-link">
