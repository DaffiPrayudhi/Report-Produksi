                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Input Data Shortage</h3>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">    
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="komponen" id="komponen" class="form-control" autocomplete="off" placeholder="Komponen" required>
                                            </select>
                                        </div>
                                        <div class="form-group">
...
<script>
    ...
    function addTempEntry() {
        ...
        const komponen = document.getElementById('komponen').value.trim();
        const downtime = document.getElementById('downtime').value.trim();

        if (tgl_bln_thn !== '' && shift !== '' && line !== '' && komponen !== '' && downtime !== '') {
            var entry = {
                date: tgl_bln_thn,
                shift: shift,
                line: line,
    ...
    function submitData() {
        ...
        fetch('<?= base_url('user/submitScrapControlFA_st'); ?>', {
            method: 'POST',
            headers: {
