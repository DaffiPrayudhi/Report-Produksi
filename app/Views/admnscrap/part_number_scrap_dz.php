                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Input Data FTT</h3>
                        </div>
        
                        <form id="scrapForm_dz">
                            <div class="card-body card-rs">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="tgl_bln_thn">Date</label>
                                            <input type="date" name="tgl_bln_thn" id="tgl_bln_thn" class="form-control" required readonly>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">    
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="varian" id="varian" class="form-control" autocomplete="off" placeholder="Varian" required>
                                        </div>
                                        <div class="form-group">
                                            <label>ICT</label>
                                            <div class="row">
                                                <div class="col-md-10">
                                                    <input type="number" name="ok_ict" id="ok_ict" class="form-control" autocomplete="off" placeholder="OK" step="0.01">
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="header">In Pcs</div>
                                                </div>
                                                <div class="col-md-10">
                                                    <input type="number" name="ng_ict" id="ng_ict" class="form-control" autocomplete="off" placeholder="NG" step="0.01">
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="header">In Pcs</div>
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-10">
                                                    <input type="number" name="ok_fct" id="ok_fct" class="form-control" autocomplete="off" placeholder="OK" step="0.01">
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="header">In Pcs</div>
                                                </div>
                                                <div class="col-md-10">
                                                    <input type="number" name="ng_fct" id="ng_fct" class="form-control" autocomplete="off" placeholder="NG" step="0.01">
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="header">In Pcs</div>
                                                </div>
...
<script>
    ...
    function resetFields() {
        ...
        document.getElementById('ok_ict').value = '';
        document.getElementById('ng_ict').value = '';
        document.getElementById('ok_fct').value = '';
        document.getElementById('ng_fct').value = '';
    }
    ...
    function addTempEntry() {
        ...
        const ok_ict = document.getElementById('ok_ict').value.trim();
        const ng_ict = document.getElementById('ng_ict').value.trim();
        const ok_fct = document.getElementById('ok_fct').value.trim();
        const ng_fct = document.getElementById('ng_fct').value.trim();

        if (tgl_bln_thn !== '' && shift !== '' && line !== '' && model !== '' && varian !== '' && ok_ict !== '' && ng_ict !== '' && ok_fct !== ''&& ng_fct !== '') {
            var entry = {
                date: tgl_bln_thn,
                shift: shift,
                line: line,
    ...
    function renderTempData() {
        const tempHtml = tempData.map(entry => `
            <tr>
                ...
                <td>${entry.model}</td>
                <td>${entry.varian}</td>
                <td>${entry.ok_ict} Pcs</td>
                <td>${entry.ng_ict} Pcs</td>
                <td>${entry.ok_fct} Pcs</td>
                <td>${entry.ng_fct} Pcs</td>
            </tr>
        `).join('');
    ...
    function submitData() {
        ...
        fetch('<?= base_url('user/submitScrapControlFA_dz'); ?>', {
            method: 'POST',
            headers: {
