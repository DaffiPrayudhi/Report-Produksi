...
class UserModel extends Model
{
    ...
    protected $table = 'scrap_control_smt_update';
    ...
    public function get_today_solder_scrap($order = 'DESC')
{
    ...
    public function getFilteredScrapData($startDate, $endDate, $model = null, $mesin = null, $tipe_ng = null, $line = null)
    {
        $builder = $this->db->table($this->table);
        
        $builder->select("model, mesin, line, CONVERT(VARCHAR, tgl_bln_thn, 23) as date, SUM(qty) as total_qty");
        ...
        $builder->groupBy("model, mesin, line, CONVERT(VARCHAR, tgl_bln_thn, 23)");
    ...
    public function getScrapControlDataSortedByDate($startDate, $endDate, $model = null, $mesin = null, $tipe_ng = null, $line = null) 
    {
        $builder = $this->table($this->table);
        ...
        $builder->orderBy('MONTH(tgl_bln_thn)', 'ASC')
                ->orderBy('DAY(tgl_bln_thn)', 'ASC');

        return $builder->get()->getResultArray();
    }


    public function getPieChartData($startDate, $endDate, $model = null, $mesin = null, $tipe_ng = null, $line = null)
    {
        $builder = $this->db->table($this->table);
    ...
    public function getTotalQty($startDate, $endDate, $model = null, $mesin = null, $tipe_ng = null, $line = null)
    {
        $builder = $this->db->table($this->table);
    ...
    public function getFilteredScrapDataExcel($startDate, $endDate, $model = null, $mesin = null, $tipe_ng = null, $line = null)
    {
        ...
        $builder->select("model, mesin, line, part_number, shift, scraptype, tipe_ng, remarks, qty, CONVERT(VARCHAR, tgl_bln_thn, 23) as date, SUM(qty) as total_qty");
